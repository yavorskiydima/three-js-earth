...
function activateNet() {
  ...
  setTimeout(() => {
    ...
    earth.line('Союз «ТПП Республики Саха (Якутия)»', 'Союз «ТПП Амурской области»');
    ...
    earth.line('Союз «ТПП Республики Саха (Якутия)»', 'Союз «ТПП Ямало-Ненецкого автономного округа»');
    earth.line('Союз «ТПП г.Братска»', 'Союз «ТПП Республики Тыва»');
    earth.line('Союз «ТПП Республики Тыва»', 'Союз «ТПП Восточной Сибири»');
    earth.line('Союз «ТПП г.Братска»', 'Союз «Южно-региональная ТПП Красноярского края»');
    earth.line('Союз «Южно-региональная ТПП Красноярского края»', 'Союз «ТПП Республики Тыва»');
    earth.line('Союз «ТПП г.Братска»', 'Союз «Центрально-Сибирская ТПП»');
    earth.line('Союз «Центрально-Сибирская ТПП»', 'Союз «Южно-региональная ТПП Красноярского края»');
    earth.line('Союз «ТПП Республики Тыва»', 'Союз «ТПП Республики Алтай»');
    earth.line('Союз «ТПП Республики Алтай»', 'Союз «Южно-региональная ТПП Красноярского края»');
    earth.line('Союз «ТПП Республики Алтай»', 'Союз «Кузбасская ТПП»');
    earth.line('Союз «Кузбасская ТПП»', 'Союз «Южно-региональная ТПП Красноярского края»');
    ...
    earth.line('Союз «ТПП Ямало-Ненецкого автономного округа»', 'Союз «Нижневартовская ТПП»');
    earth.line('Союз «Нижневартовская ТПП»', 'Союз «Сургутская ТПП»');
    earth.line('Союз «Сургутская ТПП»', 'Союз «ТПП Ямало-Ненецкого автономного округа»');
    ...
    earth.line('Союз «Сургутская ТПП»', 'Союз «ТПП Ханты-Мансийского автономного округа - Югры»');
    earth.line('Союз «ТПП Ханты-Мансийского автономного округа - Югры»', 'Союз «ТПП Ямало-Ненецкого автономного округа»');
    earth.line('Союз «Омская ТПП»', 'Союз «ТПП Ханты-Мансийского автономного округа - Югры»');
    earth.line('Союз «ТПП Ханты-Мансийского автономного округа - Югры»', 'Союз «Няганская ТПП»');
    earth.line('Союз «Няганская ТПП»', 'Союз «ТПП Ямало-Ненецкого автономного округа»');
    earth.line('Союз «Няганская ТПП»', 'Союз «ТПП г.Ухты»');
    earth.line('Союз «ТПП г.Ухты»', 'Союз «ТПП Ямало-Ненецкого автономного округа»');
    earth.line('Союз «Нижневартовская ТПП»', 'Союз «ТПП Республики Саха (Якутия)»');
    earth.line('Союз «Нижневартовская ТПП»', 'Союз «ТПП г.Братска»');
    earth.line('Союз «ТПП г.Братска»', 'Союз «ТПП Республики Саха (Якутия)»');
    earth.line('Союз «Забайкальская ТПП»', 'Союз «ТПП Республики Саха (Якутия)»');
    earth.line('Союз «ТПП г.Ухты»', 'Союз «Архангельская ТПП»');
    earth.line('Союз «Архангельская ТПП»', 'Союз «ТПП Ямало-Ненецкого автономного округа»');
    earth.line('Союз «Архангельская ТПП»', 'Союз «ТПП Мурманской области»');
    earth.line('Союз «ТПП Мурманской области»', 'Союз «ТПП Ямало-Ненецкого автономного округа»');
    earth.line('Союз «Омская ТПП»', 'Союз «ТПП Тюменской области»');
    earth.line('Союз «ТПП Тюменской области»', 'Союз «ТПП Ханты-Мансийского автономного округа - Югры»');
    ...
    earth.line('Союз «Магнитогорская ТПП»', 'Союз «ТПП Республики Башкортостан»');
    earth.line('Союз «ТПП Республики Башкортостан»', 'Союз «Южно-Уральская ТПП»');
    ...
    earth.line('Союз «ТПП Оренбургской области»', 'Союз «ТПП Республики Башкортостан»');
    ...
    earth.line('Союз «Санкт-Петербургская ТПП»', 'Союз «ТПП Республики Карелия»');
    ...
    earth.line('Союз «ТПП Самарской области»', 'Союз «ТПП Оренбургской области»');
    earth.line('Союз «ТПП Самарской области»', 'Союз «ТПП г.Альметьевск и Альметьевского района»');
    earth.line('Союз «ТПП г.Альметьевск и Альметьевского района»', 'Союз «ТПП Оренбургской области»');
    earth.line('Союз «ТПП Республики Башкортостан»', 'Союз «ТПП г.Альметьевск и Альметьевского района»');
    earth.line('Союз «ТПП г.Набережные Челны и региона «Закамье»', 'Союз «ТПП Республики Башкортостан»');
    earth.line('Союз «ТПП г.Альметьевск и Альметьевского района»', 'Союз «ТПП г.Набережные Челны и региона «Закамье»');
    earth.line('Союз «ТПП г.Набережные Челны и региона «Закамье»', 'Союз «Удмуртская ТПП»');
    earth.line('Союз «ТПП г.Набережные Челны и региона «Закамье»', 'Союз «Вятская ТПП»');
    earth.line('Союз «Вятская ТПП»', 'Союз «ТПП Республики Татарстан»');
    earth.line('Союз «ТПП г.Набережные Челны и региона «Закамье»', 'Союз «ТПП Республики Татарстан»');
    earth.line('Союз «ТПП Республики Татарстан»', 'Союз «ТПП г.Альметьевск и Альметьевского района»');
    earth.line('Союз «Ульяновская областная ТПП»', 'Союз «ТПП Республики Татарстан»');
    earth.line('Союз «ТПП г.Альметьевск и Альметьевского района»', 'Союз «Ульяновская областная ТПП»');
    earth.line('Союз «ТПП Самарской области»', 'Союз «Ульяновская областная ТПП»');
    earth.line('Союз «Санкт-Петербургская ТПП»', 'Союз «Новгородская ТПП»');
    earth.line('Союз «Новгородская ТПП»', 'Союз «Вологодская ТПП»');
    earth.line('Союз «Санкт-Петербургская ТПП»', 'Союз «ТПП Псковской области»');
    ...
    earth.line('Союз «ТПП Республики Калмыкия»', 'Союз «ТПП Республики Дагестан»');
    ...
    earth.line('Союз «ТПП Саратовской области»', 'Союз «ТПП Самарской области»');
    earth.line('Союз «Волгоградская ТПП»', 'Союз «ТПП Саратовской области»');
    earth.line('Союз «ТПП Саратовской области»', 'Союз «Ульяновская областная ТПП»');
    earth.line('Союз «ТПП Республики Калмыкия»', 'Союз «ТПП Кабардино-Балкарской Республики»');
    earth.line('Союз «ТПП Республики Дагестан»', 'Союз «ТПП Кабардино-Балкарской Республики»');
    earth.line('Союз «ТПП Кабардино-Балкарской Республики»', 'Союз «ТПП г.Сочи»');
    earth.line('Союз «Крымская ТПП»', 'Союз «ТПП г.Сочи»');
    earth.line('Союз «ТПП г.Сочи»', 'Союз «ТПП Ставропольского края»');
    earth.line('Союз «ТПП Ставропольского края»', 'Союз «ТПП Кабардино-Балкарской Республики»');
    earth.line('Союз «ТПП Республики Калмыкия»', 'Союз «ТПП Ставропольского края»');
    earth.line('Союз «Крымская ТПП»', 'Союз «ТПП Ростовской области»');
    earth.line('Союз «ТПП Ростовской области»', 'Союз «ТПП г.Сочи»');
    earth.line('Союз «ТПП Ростовской области»', 'Союз «ТПП Ставропольского края»');
    earth.line('Союз «ТПП Республики Калмыкия»', 'Союз «ТПП Ростовской области»');
    earth.line('Союз «Крымская ТПП»', 'Союз «ТПП Воронежской области»');
    earth.line('Союз «ТПП Воронежской области»', 'Союз «ТПП Ростовской области»');
    ...
    earth.line('Союз «ТПП Саратовской области»', 'Союз «ТПП Воронежской области»');
    ...
    earth.line('Союз «Ярославская областная ТПП»', 'Союз «ТПП Нижегородской области»');
    ...
    earth.line('Союз «ТПП Нижегородской области»', 'Союз «ТПП Республики Татарстан»');
    earth.line('Союз «Рязанская ТПП»', 'Союз «ТПП Республики Мордовия»');
    earth.line('Союз «ТПП Нижегородской области»', 'Союз «ТПП Республики Мордовия»');
    earth.line('Союз «Ульяновская областная ТПП»', 'Союз «ТПП Республики Мордовия»');
    earth.line('Союз «ТПП Республики Мордовия»', 'Союз «ТПП Республики Татарстан»');
    earth.line('Союз «ТПП Саратовской области»', 'Союз «ТПП Республики Мордовия»');
