...
function activateNet() {
  ...
  setTimeout(() => {
    ...
    earth.line('Союз «ТПП Ставропольского края»', 'Союз «ТПП Краснодарского края»');
    earth.line('Союз «ТПП Краснодарского края»', 'Союз «ТПП Ростовской области»');
    ...
    earth.line('Союз «ТПП г.Сочи»', 'Союз «ТПП Кабардино-Балкарской Республики»');
  }, 1300);
}
